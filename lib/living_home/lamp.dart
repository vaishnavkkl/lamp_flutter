...
class Lamp extends StatelessWidget {
  ...
  const Lamp({Key key, @required this.screenWidth, @required this.screenHeight, @required this.color, @required this.isSwitchOn,@required this.gradientColor,this.animationDuration}) : super(key: key);
